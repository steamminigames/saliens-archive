...
function LoadAsset( strName, strURI, cacheKey, loader ) {
	window.assets.push(strURI);
	strURI = strURI
		.replace("https://steamcdn-a.akamaihd.net/steamcommunity/public/", "./")
		.replace("https://steamcommunity-a.akamaihd.net/public/", "./");
